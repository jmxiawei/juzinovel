 ...
 */
public class BookContentAdapter2 extends PagerAdapter {
    ...
    public BookContentAdapter2 setPageScrollListener(IPageScrollListener pageScrollListener) {
        this.pageScrollListener = pageScrollListener;
        notifyDataSetChanged();
        return this;
    }

    public BookContentAdapter2 setmLoadChapter(ILoadChapter mLoadChapter) {
