...
public class SearchPresenter extends MvpBasePresenter<SearchView> {
     ...
     * @param keyword
     */
    public  void searchBook(String keyword,String catename,String ranklistid,int page){
      ...
      retrofit2.Call<BaseModel<ArrayList<Book>>> arrayListCall =  BaseHttpHandler.create().getProxy(BookService.class).search("Book.search",keyword,catename,ranklistid,page);
